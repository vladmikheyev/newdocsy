...
Суть такова: "Девятка" **ТЕТ** (сосуд) придает изначально бесформенной **МЕМ** (ивр.: мАим - вода) нужную форму. Так формируется "поляризованная" комбинация **МЕМ** (40) + **ТЕТ** (9), т.е. **49**

И таким образом, в комбинации **ШИН** - **АЛЕФ** - **МЕМ** против "Горячего полюса" ("Двойка") фактически работает "ТЕТ" ("Девятка")

#### Имеем: "**БЕТ** VS **ТЕТ**" или "**2** VS **9**"
