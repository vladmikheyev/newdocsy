...
- важный вывод относительно `Алеф` - 1-цы: она идет вместе с `Бет` на вторых ролях, но в качестве усиливающего дополнения. Т.е. речь идет о комбинации `"21"`, как эманации `"Двойки"`     <a href="/docs/vektornoje-kolco/#dvadcatodin">как эманации `"Двойки"`</a> , обеспечивающей защиту и усиление.
